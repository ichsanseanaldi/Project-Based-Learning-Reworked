							...
							if (!t.metaKey && !t.ctrlKey && !t.shiftKey && !t.altKey) {
								if (t.button === 0) {
									...
									if (
										...
										this.loadPage(
											{ url: n.getAddress(), customTransition: o },
											false
										);
									}
								}
							...
							if (this.options.preload) {
								...
								if (
									...
									this.preloadPromise = new Promise(function (e, i) {
										n.getPage({ url: r.getAddress() }, function (o, s) {
											if (s.status === 500) {
			...
			e.exports = function (e) {
				...
				for (var i = 0; i < this.options.elements.length; i++) {
					if (e.querySelector(this.options.elements[i]) == null) {
						console.warn(
							"Element " + this.options.elements[i] + " is not in current page."
						);
					} else {
		...
		function (e, t, n) {
			...
			e.exports = function (e) {
				...
				return new Promise(function (e, r) {
					if (
						n.getAddress() != t.currentUrl &&
						!t.cache.exists(n.getAddress())
					) {
						t.getPage({ url: n.getAddress() }, function (i, o) {
							if (o.status === 500) {
