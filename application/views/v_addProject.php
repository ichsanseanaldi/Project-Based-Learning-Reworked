  ...
  <body>
    ...
    <div class="container">
      <div class="content">
        ...
        <div class="form-wrap">
        <form class="" action="<?php echo site_url('guru/addProjectPross'); ?>" method="post">
          ...
          <div class="input-group">
            <textarea name="keterangan_project" rows="8" cols="80" placeholder="Keterangan" required></textarea>
            <p><?php echo form_error('keterangan_project');?></p>
          </div>
          <div class="input-group button">
            <button type="submit" name="submit">Buat Project</button>
          </div>
        </form>
      </div>
      </div>
